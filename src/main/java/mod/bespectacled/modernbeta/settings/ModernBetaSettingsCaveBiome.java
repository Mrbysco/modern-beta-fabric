...
public class ModernBetaSettingsCaveBiome implements ModernBetaSettings {
	...
	public static ModernBetaSettingsCaveBiome fromCompound(CompoundTag compound) {
	...
	public static class Builder {
		...
		public Builder() {
			String biomeLushCaves = Biomes.LUSH_CAVES.location().toString();
			String biomeDripstoneCaves = Biomes.DRIPSTONE_CAVES.location().toString();
			String biomeDeepDark = Biomes.DEEP_DARK.location().toString();

			this.biomeProvider = ModernBetaBuiltInTypes.CaveBiome.VORONOI.id;
			this.singleBiome = Biomes.LUSH_CAVES.location().toString();
		...
		public Builder fromCompound(CompoundTag compound) {
