...
public class ModernBetaBiomes {
	public static final ResourceKey<Biome> BETA_FOREST = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_FOREST));
	public static final ResourceKey<Biome> BETA_SHRUBLAND = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_SHRUBLAND));
	public static final ResourceKey<Biome> BETA_DESERT = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_DESERT));
	public static final ResourceKey<Biome> BETA_SAVANNA = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_SAVANNA));
	public static final ResourceKey<Biome> BETA_PLAINS = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_PLAINS));
	public static final ResourceKey<Biome> BETA_SEASONAL_FOREST = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_SEASONAL_FOREST));
	public static final ResourceKey<Biome> BETA_RAINFOREST = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_RAINFOREST));
	public static final ResourceKey<Biome> BETA_SWAMPLAND = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_SWAMPLAND));
	public static final ResourceKey<Biome> BETA_TAIGA = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_TAIGA));
	public static final ResourceKey<Biome> BETA_TUNDRA = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_TUNDRA));
	public static final ResourceKey<Biome> BETA_ICE_DESERT = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_ICE_DESERT));

	public static final ResourceKey<Biome> BETA_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_OCEAN));
	public static final ResourceKey<Biome> BETA_LUKEWARM_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_LUKEWARM_OCEAN));
	public static final ResourceKey<Biome> BETA_WARM_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_WARM_OCEAN));
	public static final ResourceKey<Biome> BETA_COLD_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_COLD_OCEAN));
	public static final ResourceKey<Biome> BETA_FROZEN_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_FROZEN_OCEAN));

	public static final ResourceKey<Biome> BETA_SKY = keyOf(ModernBeta.createId(ModernBetaBiomeTags.BETA_SKY));

	public static final ResourceKey<Biome> PE_FOREST = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_FOREST));
	public static final ResourceKey<Biome> PE_SHRUBLAND = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_SHRUBLAND));
	public static final ResourceKey<Biome> PE_DESERT = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_DESERT));
	public static final ResourceKey<Biome> PE_SAVANNA = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_SAVANNA));
	public static final ResourceKey<Biome> PE_PLAINS = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_PLAINS));
	public static final ResourceKey<Biome> PE_SEASONAL_FOREST = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_SEASONAL_FOREST));
	public static final ResourceKey<Biome> PE_RAINFOREST = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_RAINFOREST));
	public static final ResourceKey<Biome> PE_SWAMPLAND = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_SWAMPLAND));
	public static final ResourceKey<Biome> PE_TAIGA = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_TAIGA));
	public static final ResourceKey<Biome> PE_TUNDRA = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_TUNDRA));
	public static final ResourceKey<Biome> PE_ICE_DESERT = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_ICE_DESERT));

	public static final ResourceKey<Biome> PE_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_OCEAN));
	public static final ResourceKey<Biome> PE_LUKEWARM_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_LUKEWARM_OCEAN));
	public static final ResourceKey<Biome> PE_WARM_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_WARM_OCEAN));
	public static final ResourceKey<Biome> PE_COLD_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_COLD_OCEAN));
	public static final ResourceKey<Biome> PE_FROZEN_OCEAN = keyOf(ModernBeta.createId(ModernBetaBiomeTags.PE_FROZEN_OCEAN));

	public static final ResourceKey<Biome> ALPHA = keyOf(ModernBeta.createId(ModernBetaBiomeTags.ALPHA));
	public static final ResourceKey<Biome> ALPHA_WINTER = keyOf(ModernBeta.createId(ModernBetaBiomeTags.ALPHA_WINTER));

	public static final ResourceKey<Biome> INFDEV_611 = keyOf(ModernBeta.createId(ModernBetaBiomeTags.INFDEV_611));
	public static final ResourceKey<Biome> INFDEV_420 = keyOf(ModernBeta.createId(ModernBetaBiomeTags.INFDEV_420));
	public static final ResourceKey<Biome> INFDEV_415 = keyOf(ModernBeta.createId(ModernBetaBiomeTags.INFDEV_415));
	public static final ResourceKey<Biome> INFDEV_227 = keyOf(ModernBeta.createId(ModernBetaBiomeTags.INFDEV_227));

	public static final ResourceKey<Biome> INDEV_NORMAL = keyOf(ModernBeta.createId(ModernBetaBiomeTags.INDEV_NORMAL));
	public static final ResourceKey<Biome> INDEV_HELL = keyOf(ModernBeta.createId(ModernBetaBiomeTags.INDEV_HELL));
	public static final ResourceKey<Biome> INDEV_PARADISE = keyOf(ModernBeta.createId(ModernBetaBiomeTags.INDEV_PARADISE));
	public static final ResourceKey<Biome> INDEV_WOODS = keyOf(ModernBeta.createId(ModernBetaBiomeTags.INDEV_WOODS));
