...
public class NoiseBasedCountPlacementModifierInfdev420 extends NoiseBasedCountPlacementModifier {
	public static final MapCodec<NoiseBasedCountPlacementModifierInfdev420> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(
	...
	public PlacementModifierType<?> type() {
		return ModernBetaPlacementTypes.INFDEV_420_NOISE_BASED_COUNT.get();
	}
