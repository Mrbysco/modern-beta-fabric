...
public class NoiseProviderBase extends NoiseProvider {
	...
	public void sampleNoiseYHeightmap(double deltaY) {
		this.heightmapNW = Mth.lerp(deltaY, this.heightmapLowerNW, this.heightmapUpperNW);
		this.heightmapSW = Mth.lerp(deltaY, this.heightmapLowerSW, this.heightmapUpperSW);
		this.heightmapNE = Mth.lerp(deltaY, this.heightmapLowerNE, this.heightmapUpperNE);
		this.heightmapSE = Mth.lerp(deltaY, this.heightmapLowerSE, this.heightmapUpperSE);
	}

	public void sampleNoiseXHeightmap(double deltaX) {
		this.heightmapN = Mth.lerp(deltaX, this.heightmapNW, this.heightmapNE);
		this.heightmapS = Mth.lerp(deltaX, this.heightmapSW, this.heightmapSE);
	}

	public void sampleNoiseZHeightmap(double deltaZ) {
		this.heightmapDensity = Mth.lerp(deltaZ, this.heightmapN, this.heightmapS);
	}
